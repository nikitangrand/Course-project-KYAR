...
document.addEventListener('DOMContentLoaded', () => {
    fetch('../Xml/houses.xml')
        ...
        .then(xmlData => {
            ...
            xmlDoc.querySelectorAll('house').forEach(item => {
                ...
                card.innerHTML = `
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-info">
                            ...
                            <p>Этажи: ${item.querySelector('floors').textContent}</p>
                            <p>Участок: ${item.querySelector('land_area').textContent} м²</p>
